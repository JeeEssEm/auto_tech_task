...
const mockGraph: KnowledgeGraph = {
  nodes: [
    { id: "1", label: "Система СкладПро", type: "entity" },
    { id: "2", label: "Приёмка товара", type: "module" },
    { id: "3", label: "Инвентаризация", type: "module" },
    { id: "4", label: "Заказы поставщикам", type: "module" },
    { id: "5", label: "Кладовщик", type: "actor" },
    { id: "6", label: "Менеджер", type: "actor" },
    { id: "7", label: "10 000 SKU", type: "requirement" },
    { id: "8", label: "API ≤ 200 мс", type: "requirement" },
    { id: "9", label: "Интеграция 1С", type: "module" },
    { id: "10", label: "Отчётность", type: "module" },
  ],
  edges: [
    { from: "1", to: "2", label: "включает" },
    { from: "1", to: "3", label: "включает" },
    { from: "1", to: "4", label: "включает" },
    { from: "1", to: "9", label: "включает" },
    { from: "1", to: "10", label: "включает" },
    { from: "5", to: "2", label: "использует" },
    { from: "5", to: "3", label: "использует" },
    { from: "6", to: "4", label: "управляет" },
    { from: "6", to: "10", label: "просматривает" },
    { from: "1", to: "7", label: "требование" },
    { from: "1", to: "8", label: "требование" },
  ],
}
